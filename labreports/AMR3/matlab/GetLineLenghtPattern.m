...
for i=0:7
  ...
  % Compute the string
  S = ComputePatStringLineLengths(NLines, segend, seglen, 100);
...
if training == 'l'
    save 'LabeledLineLengthSignatures.mat' PatStrings PlaceID;
else 
    save 'UnlabeledLineLengthSignatures.mat' PatStrings;
end
%close all
return
