...
Tevens was het bestand imgflipud.m aangepast. Het bestand imgflipud.m zou een functie moeten leveren om een plaatje verticaal te spiegelen om zijn middelpunt. Het gegeven bestand gaf echter een functie die helemaal niks deet met het plaatje.
...
% Note: Getlaserscans bevat onze parameter waarden maar calibratescans bevat ander waarden voor alpha etc. whats up with that ==> we hebben nooit de calibratie gebruikt%
