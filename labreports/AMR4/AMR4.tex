...
\includegraphics[width=0.5\textwidth]{{img/slam100particles}.png} &
\includegraphics[width=0.5\textwidth]{{img/slam200particles}.png}
\end{array}$
\includegraphics[width=0.5\textwidth]{{img/slam1000particles}.png}
\end{center}
